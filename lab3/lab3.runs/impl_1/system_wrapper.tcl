...
set rc [catch {
  ...
  open_checkpoint D:/123456/em15-340-yangxi/lab2/lab2.runs/impl_1/system_wrapper.dcp
  set_property webtalk.parent_dir D:/123456/em15-340-yangxi/lab2/lab2.cache/wt [current_project]
  set_property parent.project_dir D:/123456/em15-340-yangxi/lab2 [current_project]
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {d:/123456/em15-340-yangxi/lab2/lab2.cache} }
  opt_design 
...
set rc [catch {
  ...
  if { [file exists D:/123456/em15-340-yangxi/lab2/lab2.runs/synth_1/system_wrapper.hwdef] } {
    catch { write_sysdef -hwdef D:/123456/em15-340-yangxi/lab2/lab2.runs/synth_1/system_wrapper.hwdef -bitfile system_wrapper.bit -meminfo system_wrapper_bd.bmm -file system_wrapper.sysdef }
  }
